...
<html lang="en">
    ...
    <body>
        <header>
            <h1><img src="<?=base_url()?>assets/css/generator/images/generator.png" alt="generator" />Form Generator for CodeIgniter</h1>
        </header>
        ...
        <section id="creator"> 
            <ul id="add">
                ...
                <li><span value="date">Date (jUI)</span></li>
                <li><span value="datetime">Datetime (jUI)</span></li>
